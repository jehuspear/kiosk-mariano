...
CREATE TABLE `ingredient` (
  ...
  `Ingredient_StockQuantity` float NOT NULL,
...
(1, 'Kape Amerikano', 'Images/menu-item/kape-americano.jpg', 'Full-bodied espresso with hot water', 'Coffee', 1299, 4, 'Available'),
...
(3, 'Cappuccino', 'Images/menu-item/cappuccino.jpg', 'Espresso with steamed milk and a thick layer of foam', 'Coffee', 1487, 3, 'Available'),
(4, 'Latte Espanyol', 'Images/menu-item/latte-espanyol.jpg', 'Espresso combined with milk and a hint of condensed milk', 'Coffee', 1465, 30, 'Available'),
(5, 'Kape Dulce Salty Caramelo', 'Images/menu-item/kape-dulce-salty-caramelo.jpg', 'Espresso combined with milk, infused with salted caramel syrup', 'Coffee', 1469, 22, 'Available'),
(6, 'Kape con Canela', 'Images/menu-item/kape-con-canela.jpg', 'Espresso combined with steamed milk and infused with honey and cinnamon', 'Coffee', 1474, 20, 'Available'),
(7, 'Kape de Cacao', 'Images/menu-item/kape-de-cacao.jpg', 'Espresso combined with steamed milk and rich chocolate syrup', 'Coffee', 1487, 3, 'Available'),
(10, 'Espresso (Doppio)', 'Images/menu-items/Doppio_Espresso_Macchiato.jpg', 'Espresso (Doppio) is a rich, concentrated coffee brewed by forcing hot water through finely-ground coffee beans, resulting in a bold, full-bodied flavor. A doppio, meaning \"double\" in Italian, is simply a double shot of espresso, offering twice the intensity and depth in a single serving.', 'Traditional Coffee', 9, 25, 'Available'),
...
(12, 'Blue Punch Mocktail', 'Images/menu-item/blue_mocktail.jpg', 'A vibrant blue mocktail garnished with a cherry and lemon slice, served over crushed ice with a striped straw for a refreshing tropical flair.', 'Mocktail', 287, 12, 'Available'),
(13, 'Matcha Latte', 'Images/menu-item/matcha-latte.jpg', 'A creamy matcha latte with swirling layers of vibrant green tea and silky milk, perfect for a refreshing boost.', 'Non-Coffee', 865, 31, 'Available'),
(14, 'Black Forest cake ', 'Images/menu-item/black-forest-pastry.jpg', 'A decadent slice of Black Forest cake layered with rich chocolate sponge, whipped cream, cherries, and topped with chocolate shavings and a cherry garnish.', 'Pastries', 2, 5, 'Available'),
(15, 'Strawberry Latte', 'Images/menu-item/sakura-strawberry-latte1.jpg', 'Enjoy a sip of this delicious strawberry flavored drink!', 'Non-Coffee', 1492, 3, 'Available'),
(16, 'Chocolate Latte', 'Images/menu-item/chocolate latte1.jpg', 'A sweet chocolate flavored drink!', 'Non-Coffee', 1489, 5, 'Available'),
(17, 'Shirley Temple', 'Images/menu-item/shirly temple.jpg', 'Shirley Temples are fun, simple, and absolutely refreshing friendly mocktail', 'Mocktail', 291, 8, 'Available'),
(18, 'Strawberry Kiss', 'Images/menu-item/strawberry-lemon-mocktail-5411.jpg', 'A delicious sweet strawberry drink that will mark your lips with a delight!', 'Mocktail', 294, 5, 'Available'),
(19, 'Orange Sunrise', 'Images/menu-item/orange sunrise.jpg', 'Need a fun brunch drink. This sunrise mocktail has you covered. It is eye-catching, tasty, and 100% alcohol-free.', 'Mocktail', 293, 6, 'Available'),
(20, 'Brownies', 'Images/menu-item/brownies.jpg', 'Dense, fudgy, chewy, chocolate brownies! These decadent brownies are a delicious combination of fresh, sweet cherries and chocolate!', 'Pastries', 98, 2, 'Available'),
(21, 'Banana Bread', 'Images/menu-item/banana bread.jpg', 'This Banana Loaf recipe is very moist with just the right sweetness and has that perfect banana flavor.', 'Pastries', 292, 2, 'Available'),
...
(23, 'Air Fried French Fries', 'Images/menu-item/Crispy Air Fried French Fries.jpg', 'These air fryer French fries are just as crispy and crunchy as regular fries. They are easy and delicious! They use far less oil, so as a result, these fries are far healthier than average ones.', 'Snacks', 597, 3, 'Available'),
(24, 'Cafe BonBon', 'Images/menu-item/Bonbon.jpg', 'Discover the delightful cafe bonbon, a sweet and ultra creamy coffee treat.\r\n', 'Traditional Coffee', 27, 15, 'Available'),
(25, 'Traditional Macchiato', 'Images/menu-item/macchiatotraditonal-11.jpg', 'the macchiato is quite a literal drink - it is an espresso marked with a dollop of frothed milk, and nothing else (macchiato means marked in Italian). ', 'Traditional Coffee', 298, 2, 'Available'),
(26, 'Piccolo', 'Images/menu-item/piccolo.jpg', 'a small coffee composed of a single espresso shot and heated milk.', 'Traditional Coffee', 271, 28, 'Available'),
(27, 'Caesar Salad', 'Images/menu-item/Caesar-Salad.jpg', 'This vibrant Caesar salad features crisp romaine lettuce, golden crunchy croutons, and shaved Parmesan cheese, all tossed in a creamy dressing.', 'Snacks', 8, 5, 'Available');
...
(16, 4, '8oz', 'Hot', 90.00, 0, 299),
(17, 4, '12oz', 'Hot', 120.00, 0, 299),
(18, 4, '12oz', 'Iced', 120.00, 0, 299),
(19, 4, '16oz', 'Iced', 130.00, 0, 299),
...
CREATE TABLE `recipe` (
  ...
  `MenuItem_ID` int(11) NOT NULL,
  `Ingredient_ID` int(11) NOT NULL,
  `Recipe_QuantityRequired` float NOT NULL,
  `Recipe_Unit` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `recipe`
  ...
  ADD KEY `fk_recipe_menuitem_id` (`MenuItem_ID`),
  ADD KEY `fk_recipe_ingredient_id` (`Ingredient_ID`);
...
--
ALTER TABLE `recipe`
  ADD CONSTRAINT `fk_recipe_ingredient_id` FOREIGN KEY (`Ingredient_ID`) REFERENCES `ingredient` (`Ingredient_ID`),
  ADD CONSTRAINT `fk_recipe_menuitem_id` FOREIGN KEY (`MenuItem_ID`) REFERENCES `menuitem` (`MenuItem_ID`);
COMMIT;
