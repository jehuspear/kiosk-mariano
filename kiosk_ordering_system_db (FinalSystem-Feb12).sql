...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2025 at 10:31 PM
...
(12, 'Blue Punch Mocktail', 'Images/menu-item/blue_mocktail.jpg', 'A vibrant blue mocktail garnished with a cherry and lemon slice, served over crushed ice with a striped straw for a refreshing tropical flair.', 'Mocktail', 292, 7, 'Available'),
...
(93, NULL, 'Dine-in', 2, '2025-02-12 05:07:05', '2025-02-12 05:29:52', 1440.00, 93, 'GCash', 2, 'ReadyToClaim');
...
--
ALTER TABLE `orderitem`
  MODIFY `OrderItem_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
